...
pub fn build_card(
    ...
    bg.children = vec![
        n(base + ids::CARD_ACCENT_BAR),
        n(base + ids::CARD_STATUS_DOT),
        n(base + ids::CARD_LABEL),
        n(base + ids::CARD_VALUE),
        n(base + ids::CARD_BAR_TRACK),
        n(base + ids::CARD_BAR_FILL),
        n(base + ids::CARD_FOOTER_LEFT),
        n(base + ids::CARD_FOOTER_RIGHT),
    ];
